                ...
                <table class="table table-bordered datatable" id="table_export">
                	<thead>
                		<tr>
                            ...
                            <th><div><?php echo get_phrase('course_no');?></div></th>
                	...
                	<?php echo form_open('teacher/subject/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('course_no');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="course_no" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"/>
                                </div>
                            </div>
