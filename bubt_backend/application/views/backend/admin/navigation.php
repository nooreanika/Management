		...
		<ul id="main-menu" class="">
           ...
           <li class="<?php if($page_name == 'parent')echo 'opened active';?> ">
			...
			<li class="<?php if($page_name == 'stuff')echo 'active';?> ">
				<a href="<?php echo base_url();?>index.php?admin/stuff">
					<i class="entypo-users"></i>
			...
			<li class="<?php if($page_name == 'it_officer')echo 'active';?> ">
				<a href="<?php echo base_url();?>index.php?admin/it_officer">
					<i class="entypo-users"></i>
           ...
           <li class="<?php if($page_name == 'room')echo 'active';?> ">
				<a href="<?php echo base_url();?>index.php?admin/room">
					<i class="entypo-flow-tree"></i>
					<span><?php echo get_phrase('room');?></span>
				</a>
           ...
           <li class="<?php if($page_name == 'class_routine')echo 'active';?> ">
			...
			<!-- ATTENDANCE -->
			<li class="<?php if($page_name == 'attendance_scale' || $page_name == 'manage_attendance')echo 'opened active';?> ">
				<a href="#">
					<i class="entypo-chart-area"></i>
					<span><?php echo get_phrase('attendance');?></span>
				</a>
				<ul>
					<li class="<?php if($page_name == 'scale')echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?admin/scale">
