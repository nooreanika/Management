  ...
  /****MANAGE PARENTS CLASSWISE*****/
    function parent($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?teacher/parent/' . $class_id , 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        			= $this->input->post('name');
            $data['email']       			= $this->input->post('email');
            ...
            redirect(base_url() . 'index.php?teacher/parent/' . $param3, 'refresh');
        } else if ($param1 == 'edit') {
    ...
    function scale($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?teacher/scale/', 'refresh');
        }
        if ($param1 == 'do_update') {
            //$data['name']        = $this->input->post('name');
            // $data['grade_point'] = $this->input->post('grade_point');
