...
class Crud_model extends CI_Model {
    ...
    function get_type_roll_by_id($type,$type_id='',$field='roll')
	{
    ...
    function get_designation_name($teacher_id)
	{
    ...
    function get_teacher_code($teacher_id)
	{
		$query	=	$this->db->get_where('teacher' , array('teacher_id' => $teacher_id));
		$res	=	$query->result_array();
		foreach($res as $row)
	...
	function get_course_no_by_id($subject_id)
	{
		$query	=	$this->db->get_where('subject' , array('subject_id' => $subject_id))->row();
		return $query->course_no;
	}
    
    function get_course_no($subject_id)
	{
		$query	=	$this->db->get_where('subject' , array('subject_id' => $subject_id))->row();
		return $query->course_no;
	}
    ...
    function get_room_no_by_id($room_id)
	{
		$query	=	$this->db->get_where('room' , array('room_id' => $room_id))->row();
		return $query->room_no;
	}
